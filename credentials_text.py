...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_credentials = Credentials("immo", "AdrianEDDIE", "qwerty123")
    ...
    def test__init__(self):
        ...
        '''
        self.assertEqual(self.new_credentials.website_name, "immo")
        self.assertEqual(self.new_credentials.user_name, "AdrianEDDIE")
